...
sealed class MainEvent {
    ...
    data class OnChangeChangelogLastSeenVersionCode(val value: Int) : MainEvent()
    ...
    data class OnChangeTranslationProviderMode(val value: String) : MainEvent()
    data class OnChangeTranslationSourceLanguage(val value: String) : MainEvent()
    data class OnChangeTranslationTargetLanguage(val value: String) : MainEvent()
    data object OnSwapTranslationLanguages : MainEvent()
    data class OnChangeTranslationWifiOnly(val value: Boolean) : MainEvent()
    ...
    data class OnChangeLibraryShowDefaultTab(val value: Boolean) : MainEvent()
    ...
    data class OnChangePdfDefaultReadingMode(val value: String) : MainEvent()
    data class OnChangePdfPageDisplayMode(val value: String) : MainEvent()
    data class OnChangePdfShowZoomControls(val value: Boolean) : MainEvent()
    data class OnChangePdfPinchZoom(val value: Boolean) : MainEvent()
    ...
    data class OnChangeTtsSpeechRate(val value: Float) : MainEvent()
    data class OnChangeTtsPitch(val value: Float) : MainEvent()
    data class OnChangeTtsVoice(val value: String) : MainEvent()
    data class OnChangeTtsLanguage(val value: String) : MainEvent()
    data class OnChangeTtsBackgroundPlayback(val value: Boolean) : MainEvent()
    data class OnChangeTtsStopAtChapterEnd(val value: Boolean) : MainEvent()
    data class OnChangeTtsParagraphDelay(val value: Int) : MainEvent()
    data class OnChangeTtsAutoScroll(val value: Boolean) : MainEvent()
    data class OnChangeTtsHighlightSentence(val value: Boolean) : MainEvent()
    data class OnChangeTtsSpeakChapterTitles(val value: Boolean) : MainEvent()
}
