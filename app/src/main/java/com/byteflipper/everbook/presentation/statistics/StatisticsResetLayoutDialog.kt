...
@Composable
internal fun ResetLayoutDialog(
    onConfirm: () -> Unit,
    onDismiss: () -> Unit
) {
    AlertDialog(
        onDismissRequest = onDismiss,
        title = { StyledText(stringResource(id = R.string.statistics_reset_layout_title)) },
        text = {
            StyledText(
                text = stringResource(id = R.string.statistics_reset_layout_desc),
