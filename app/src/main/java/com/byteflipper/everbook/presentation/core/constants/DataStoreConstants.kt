...
object DataStoreConstants {
    ...
    val TTS_SPEECH_RATE = doublePreferencesKey("tts_speech_rate")
    val TTS_PITCH = doublePreferencesKey("tts_pitch")
    ...
    val TTS_STOP_AT_CHAPTER_END = booleanPreferencesKey("tts_stop_at_chapter_end")
    val TTS_PARAGRAPH_DELAY = intPreferencesKey("tts_paragraph_delay")
    val TTS_AUTO_SCROLL = booleanPreferencesKey("tts_auto_scroll")
    val TTS_HIGHLIGHT_SENTENCE = booleanPreferencesKey("tts_highlight_sentence")
    val TTS_SPEAK_CHAPTER_TITLES = booleanPreferencesKey("tts_speak_chapter_titles")
